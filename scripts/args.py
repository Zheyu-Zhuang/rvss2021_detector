...
parser.add_argument("--epochs", metavar='', type=int, default=30)
parser.add_argument("--batch_size", metavar='', type=int, default=50)
parser.add_argument("--weight_decay", metavar='', type=float, default=1.0e-4)
parser.add_argument("--scheduler_step", metavar='', type=int, default=10,
        help='the learning rate is reduced to <?>')
parser.add_argument("--scheduler_gamma", metavar='', type=float, default=0.1,
